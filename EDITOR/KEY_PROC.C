...
void key_proc_text_editor_low_level(int y, int x, int width, int height, int *i_cursor_y, int *i_cursor_x, int low_level, LINE_TAG *line_list)
{
    LINE_TAG a_line = {0, 0, NULL, NULL, NULL}; // 임시 초기화
    
    if(13 == low_level)	/* 리턴 키 */
    {
        line_insert(&a_line, &line_list);
